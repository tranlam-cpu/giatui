...
export default function SidebarNav() {
  return (
    <ul className="list-unstyled">
      ...
      <SidebarNavTitle>Người dùng</SidebarNavTitle>
        <SidebarNavItem icon={faDroplet} href="/backend/users">Danh sách tài khoản</SidebarNavItem>
        <SidebarNavItem icon={faPencil} href="/backend/banned">Danh sách cấm</SidebarNavItem>
      <SidebarNavTitle>Chức năng</SidebarNavTitle>

      <SidebarNavGroup toggleIcon={faBusinessTime} toggleText="Thời gian">
        <SidebarNavItem href="/backend/collected">Thu thập</SidebarNavItem>
        <SidebarNavItem href="#">Vận chuyển</SidebarNavItem>
      </SidebarNavGroup>
